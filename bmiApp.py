...
hight_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติดมตร):", min_value=1.0, value=1.0)
...
if st.button("คำนวณค่า BMI 🎯") :
    ...
    st.write (" ---")
    st.header(f"ค่า BMI ของคุณคือ: **{bmi :.2})**")
...
if bmi ‹ 18.5: 
  ...
  elit 23.0 ‹= bmi < 25.0:
st.info("7 คุณเริ่มมีน้ำหนักเกินเกณฑ์ (ท้วม)")
else:
st error(" *
คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย")
st.divider ()
st.write("นางสาวดีใจ ยิ้มแย่ม เลขที่ 5 ม.4/5")
